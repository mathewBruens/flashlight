        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    long randInterval = (long) ((Math.random() * (userSettings.getUserStatsMaxInterval() - userSettings.getUserStatsMinInterval())) + userSettings.getUserStatsMinInterval());
    ...
    public void startScreenCapture() {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    //long randInterval = (long) ((Math.random() * (MAX_INTERVAL - MIN_INTERVAL)) + MIN_INTERVAL);
                    long randInterval = (long) ((Math.random() * (userSettings.getScreenshotMaxInterval() - userSettings.getScreenshotMinInterval())) + userSettings.getScreenshotMinInterval());
                    try {
                        Thread.sleep(randInterval);
    ...
    public void startWebcamCapture() {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while (true) {
                    //long randInterval = (long) ((Math.random() * (MAX_INTERVAL - MIN_INTERVAL)) + MIN_INTERVAL);
                    long randInterval = (long) ((Math.random() * (userSettings.getWebcamMaxInterval() - userSettings.getWebcamMinInterval())) + userSettings.getWebcamMinInterval());
                    try {
                        Thread.sleep(randInterval);
